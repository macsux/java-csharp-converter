...
namespace System
{
    public sealed class Optional<T> 
    {
        ...
        /// </summary>
        /// <typeparam name="X">Type of the exception to be thrown</typeparam>
        ...
        public T orElseThrow<E>() where E : Exception, new() => orElseThrow(() => new E());
        ...
        /// <ul>
        /// <li>it is also an <c>Optional</c> and;
        /// <li>both instances have no value present or;
        /// <li>the present values are "equal to" each other via <c>equals()</c>.
        /// </ul>
        /// </summary>
        /// <param name="obj">An object to be tested for equality</param>
        /// <returns>{code true} if the other object is "equal to" this object</returns>
